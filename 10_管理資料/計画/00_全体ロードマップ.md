...
批判レビュー（2026-08-15）のうち、製品が嘘をつかない部分だけを直す。

正本: [`docs/superpowers/specs/2026-08-15-meaningful-improvements-roadmap.md`](../../docs/superpowers/specs/2026-08-15-meaningful-improvements-roadmap.md)

| 段 | 内容 | 先にやらないと壊れる理由 |
|----|------|--------------------------|
| H0 | 正直さ（文書・幽霊コード・LICENSE） | ゲートが旧アプリを認証している |
| H1 | 一つの真実（エンジン＝画面の pair） | UX を先に直すと間違った pair へ飛ぶ |
| H2 | 表の誤マッチ削減 | 列落ち・0.5 衝突 |
| H3 | 見つかる UX（前後差分・シート選択一本化） | H1 の後でのみ |
| H4 | 配布可能（CI・版・単一 exe 主張の一致） | H0–H3 をタグに載せる |
